  ...
  <style type="text/css">
    /* fallback */
      ...
      .demo-layout-transparent {
        background: url('public/img/i.png') center / cover;
...
<div class="demo-layout-transparent mdl-layout mdl-js-layout">
  ...
  <main class="mdl-layout__content">
    ...
    <div style="padding-top: 1%; margin-left: 25%;">

   <form action = "registered.php" method = "POST" enctype="multipart/form-data" style="background-color: rgba(0,0,0,0.8); width: 65%; height: 330%; z-index: 10;">
